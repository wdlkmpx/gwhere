...
/*! @define	GW_PLUGIN_SETTINGS_QUICK_SEARCH_FIELDS_TABLE	The table of fields */
#define GW_PLUGIN_SETTINGS_QUICK_SEARCH_FIELDS_TABLE "gw_plugin_settings_quick_search_fields_table"
/*! @define	GW_PLUGIN_SETTINGS_QUICK_SEARCH_LIST_VISIBLE	The list of visible fields */
#define GW_PLUGIN_SETTINGS_QUICK_SEARCH_LIST_VISIBLE "gw_plugin_settings_quick_search_list_visible"
/*! @define	GW_PLUGIN_SETTINGS_QUICK_SEARCH_LIST_HIDDEN	The list of hidden fields */
#define GW_PLUGIN_SETTINGS_QUICK_SEARCH_LIST_HIDDEN "gw_plugin_settings_quick_search_list_hidden"
/*! @define	GW_PLUGIN_SETTINGS_QUICK_SEARCH_SORT_CASE_SENSITIVE_CHK	The check box for case sensitive sort */
#define GW_PLUGIN_SETTINGS_QUICK_SEARCH_SORT_CASE_SENSITIVE_CHK "gw_plugin_settings_quick_search_sort_case_sensitive_chk"
/*! @define	GW_PLUGIN_SETTINGS_QUICK_SEARCH_SORT_GROUP_BY_FOLDER_CHK	The check box for group by type the result sort */
#define GW_PLUGIN_SETTINGS_QUICK_SEARCH_SORT_GROUP_BY_FOLDER_CHK "gw_plugin_settings_quick_search_sort_group_by_folder_chk"
/*! @define	GW_PLUGIN_SETTINGS_QUICK_SEARCH_AUTORESIZE_COLUMN_CHK	The check box for autoresize column */
#define GW_PLUGIN_SETTINGS_QUICK_SEARCH_AUTORESIZE_COLUMN_CHK "gw_plugin_settings_quick_search_autoresize_column_chk"
...
gint gw_plugin_settings_quick_search_pane_on_change ( GtkEntry *entry, GtkWidget *pane);
gint gw_plugin_settings_quick_search_pane_apply ( GtkWidget *pane);
gint gw_plugin_settings_quick_search_btn_show_click ( GtkButton *btn, GtkWidget *pane);
gint gw_plugin_settings_quick_search_btn_hide_click ( GtkButton *btn, GtkWidget *pane);
gboolean gw_plugin_settings_quick_search_destroy ( GtkWidget *pane, gpointer data);


gint gw_plugin_settings_quick_search_init ( GWSettingsModule **module)
{
	gint result = -1;

	if ( (*module = gw_settings_module_new ( )) != NULL )
	{
		(*module)->name = g_strdup ( _( "Quick"));
		(*module)->create = &gw_plugin_settings_quick_search_pane_create;
		(*module)->load = &gw_plugin_settings_quick_search_pane_load;
		(*module)->on_change = &gw_plugin_settings_quick_search_pane_on_change;
		(*module)->apply = &gw_plugin_settings_quick_search_pane_apply;
...
gint gw_plugin_settings_quick_search_pane_create ( GtkWindow *settings, GtkContainer *parent, GtkWidget **pane)
{
	...
	if ( settings != NULL && parent != NULL )
	{
		...
		g_object_set_data_full (G_OBJECT ( hbox), GW_PLUGIN_SETTINGS_QUICK_SEARCH_LIST_VISIBLE, clist_visible, (GDestroyNotify) g_object_unref);
		...
		g_object_set_data_full (G_OBJECT ( hbox), GW_PLUGIN_SETTINGS_QUICK_SEARCH_LIST_HIDDEN, clist_hidden, (GDestroyNotify) g_object_unref);
