...
/*!
 * @header	gwsettingsgui.h
 *		GWhere<br>
 *		Copyright (C) 2000  Sébastien LECACHEUR<br><br>
 *		This Distributed under the terms of the <a href="http://www.gnu.org/copyleft/gpl.html">GNU General Public Licence</a><br><br>
 *		This component was developed for the GWhere project.<br><br>
 * @abstract	This is a GUI component to configure some settings about the GUI.
...
#ifndef GW_GUI_GW_SETTINGS_GUI_H
#define GW_GUI_GW_SETTINGS_GUI_H
...
/*!
 * @function	gw_plugin_settings_gui_init
 * @abstract	Initializes the GUI plugin.
 * @discussion	This function initializes the GUI plugin.
