...
gint gw_plugin_settings_explorer_file_pane_create ( GtkWindow *settings, GtkContainer *parent, GtkWidget **pane)
{
	...
	if ( settings != NULL && parent != NULL )
	{
		...
		g_object_set_data_full (G_OBJECT ( hbox), GW_PLUGIN_SETTINGS_EXPLORER_FILE_LIST_VISIBLE, clist_visible, (GDestroyNotify) g_object_unref);
		...
		g_object_set_data_full (G_OBJECT ( hbox), GW_PLUGIN_SETTINGS_EXPLORER_FILE_LIST_HIDDEN, clist_hidden, (GDestroyNotify) g_object_unref);
