...
/*! @define	GW_PLUGIN_SETTINGS_EXPLORER_FILE_FIELDS_TABLE	The table of fields */
#define GW_PLUGIN_SETTINGS_EXPLORER_FILE_FIELDS_TABLE "gw_plugin_settings_explorer_file_fields_table"
/*! @define	GW_PLUGIN_SETTINGS_EXPLORER_FILE_LIST_VISIBLE	The list of visible fields */
#define GW_PLUGIN_SETTINGS_EXPLORER_FILE_LIST_VISIBLE "gw_plugin_settings_explorer_file_list_visible"
/*! @define	GW_PLUGIN_SETTINGS_EXPLORER_FILE_LIST_HIDDEN	The list of hidden fields */
#define GW_PLUGIN_SETTINGS_EXPLORER_FILE_LIST_HIDDEN "gw_plugin_settings_explorer_file_list_hidden"


gint gw_plugin_settings_explorer_file_pane_create ( GtkWindow *settings, GtkContainer *parent, GtkWidget **pane);
gint gw_plugin_settings_explorer_file_pane_load ( GtkWidget *pane);
gint gw_plugin_settings_explorer_file_pane_on_change ( GtkEntry *entry, GtkWidget *pane);
gint gw_plugin_settings_explorer_file_pane_apply ( GtkWidget *pane);
gint gw_plugin_settings_explorer_file_btn_show_click ( GtkButton *btn, GtkWidget *pane);
gint gw_plugin_settings_explorer_file_btn_hide_click ( GtkButton *btn, GtkWidget *pane);
gboolean gw_plugin_settings_explorer_file_destroy ( GtkWidget *pane, gpointer data);
...
gint gw_plugin_settings_explorer_file_init ( GWSettingsModule **module)
{
	...
	{
		(*module)->name = g_strdup ( _( "Files"));
		(*module)->create = &gw_plugin_settings_explorer_file_pane_create;
		(*module)->load = &gw_plugin_settings_explorer_file_pane_load;
		(*module)->on_change = &gw_plugin_settings_explorer_file_pane_on_change;
		(*module)->apply = &gw_plugin_settings_explorer_file_pane_apply;
...
gint gw_plugin_settings_explorer_file_pane_create ( GtkWindow *settings, GtkContainer *parent, GtkWidget **pane)
{
	...
	if ( settings != NULL && parent != NULL )
	{
		...
		gtk_object_set_data_full ( GTK_OBJECT ( hbox), GW_PLUGIN_SETTINGS_EXPLORER_FILE_LIST_VISIBLE, clist_visible, (GtkDestroyNotify) gtk_widget_unref);
		...
		gtk_object_set_data_full ( GTK_OBJECT ( hbox), GW_PLUGIN_SETTINGS_EXPLORER_FILE_LIST_HIDDEN, clist_hidden, (GtkDestroyNotify) gtk_widget_unref);
		...
		*pane = hbox;
		...
		gw_plugin_settings_explorer_file_pane_load ( hbox);
		...
		gtk_signal_connect  ( GTK_OBJECT ( hbox), "destroy", (GtkSignalFunc)gw_plugin_settings_explorer_file_destroy, NULL);
		gtk_signal_connect  ( GTK_OBJECT ( btn_hidden), "clicked", (GtkSignalFunc)gw_plugin_settings_explorer_file_btn_hide_click, hbox);
		gtk_signal_connect  ( GTK_OBJECT ( btn_show), "clicked", (GtkSignalFunc)gw_plugin_settings_explorer_file_btn_show_click, hbox);
...
gint gw_plugin_settings_explorer_file_pane_load ( GtkWidget *pane)
{
	...
	if ( pane != NULL )
	{
		list_visible = GTK_CLIST ( gtk_object_get_data ( GTK_OBJECT ( pane), GW_PLUGIN_SETTINGS_EXPLORER_FILE_LIST_VISIBLE));
		list_hidden = GTK_CLIST ( gtk_object_get_data ( GTK_OBJECT ( pane), GW_PLUGIN_SETTINGS_EXPLORER_FILE_LIST_HIDDEN));

		if ( (list_visible != NULL) && (list_hidden != NULL) )
		{
			if ( (fields = gw_plugin_settings_explorer_file_get_all_fields ( )) != NULL )
			{
			gtk_object_set_data_full ( GTK_OBJECT ( pane), GW_PLUGIN_SETTINGS_EXPLORER_FILE_FIELDS_TABLE, fields, (GtkDestroyNotify) gw_settings_explorer_field_freev);
...
gint gw_plugin_settings_explorer_file_pane_apply ( GtkWidget *pane)
{
	...
	if ( pane != NULL )
	{
		list_visible = GTK_CLIST ( gtk_object_get_data ( GTK_OBJECT ( pane), GW_PLUGIN_SETTINGS_EXPLORER_FILE_LIST_VISIBLE));
		list_hidden = GTK_CLIST ( gtk_object_get_data ( GTK_OBJECT ( pane), GW_PLUGIN_SETTINGS_EXPLORER_FILE_LIST_HIDDEN));
		fields = (GWSettingsExplorerField**)gtk_object_get_data ( GTK_OBJECT ( pane), GW_PLUGIN_SETTINGS_EXPLORER_FILE_FIELDS_TABLE);
