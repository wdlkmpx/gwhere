...
gint gw_plugin_settings_explorer_file_pane_create ( GtkWindow *settings, GtkContainer *parent, GtkWidget **pane)
{
	...
	if ( settings != NULL && parent != NULL )
	{
		...
		g_object_set_data_full (G_OBJECT ( hbox), GW_PLUGIN_SETTINGS_EXPLORER_FILE_LIST_VISIBLE, clist_visible, (GDestroyNotify) gtk_widget_unref);
		...
		g_object_set_data_full (G_OBJECT ( hbox), GW_PLUGIN_SETTINGS_EXPLORER_FILE_LIST_HIDDEN, clist_hidden, (GDestroyNotify) gtk_widget_unref);
...
gint gw_plugin_settings_explorer_file_pane_load ( GtkWidget *pane)
{
	...
	if ( pane != NULL )
	{
		list_visible = GTK_CLIST ( g_object_get_data (G_OBJECT ( pane), GW_PLUGIN_SETTINGS_EXPLORER_FILE_LIST_VISIBLE));
		list_hidden = GTK_CLIST ( g_object_get_data (G_OBJECT ( pane), GW_PLUGIN_SETTINGS_EXPLORER_FILE_LIST_HIDDEN));

		if ( (list_visible != NULL) && (list_hidden != NULL) )
		{
			if ( (fields = gw_plugin_settings_explorer_file_get_all_fields ( )) != NULL )
			{
			g_object_set_data_full (G_OBJECT ( pane), GW_PLUGIN_SETTINGS_EXPLORER_FILE_FIELDS_TABLE, fields, (GDestroyNotify) gw_settings_explorer_field_freev);
...
gint gw_plugin_settings_explorer_file_pane_apply ( GtkWidget *pane)
{
	...
	if ( pane != NULL )
	{
		list_visible = GTK_CLIST ( g_object_get_data (G_OBJECT ( pane), GW_PLUGIN_SETTINGS_EXPLORER_FILE_LIST_VISIBLE));
		list_hidden = GTK_CLIST ( g_object_get_data (G_OBJECT ( pane), GW_PLUGIN_SETTINGS_EXPLORER_FILE_LIST_HIDDEN));
		fields = (GWSettingsExplorerField**)g_object_get_data (G_OBJECT ( pane), GW_PLUGIN_SETTINGS_EXPLORER_FILE_FIELDS_TABLE);
