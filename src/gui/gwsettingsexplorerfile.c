...
gint gw_plugin_settings_explorer_file_pane_create ( GtkWindow *settings, GtkContainer *parent, GtkWidget **pane)
{
	...
	if ( settings != NULL && parent != NULL )
	{
		...
		*pane = hbox;
		...
		g_signal_connect (G_OBJECT ( hbox), "destroy", (GCallback)gw_plugin_settings_explorer_file_destroy, NULL);
		g_signal_connect (G_OBJECT ( btn_hidden), "clicked", (GCallback)gw_plugin_settings_explorer_file_btn_hide_click, hbox);
		g_signal_connect (G_OBJECT ( btn_show), "clicked", (GCallback)gw_plugin_settings_explorer_file_btn_show_click, hbox);
