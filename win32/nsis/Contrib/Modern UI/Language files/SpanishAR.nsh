...
;Language: Argentina Spanish (11274)
;By Luis PARRAVICINI

;--------------------------------

!insertmacro MUI_LANGUAGEFILE_BEGIN "SpanishAR"

  !define MUI_LANGNAME "Argentino" ;Use only ASCII characters (if this is not possible, use the English name)
